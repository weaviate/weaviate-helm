...
(
  ...
  check_modules "--set modules.generative-contextualai.enabled=true" "value: generative-contextualai"
  check_modules "--set modules.generative-contextualai.enabled=true --set modules.generative-contextualai.apiKey=apiKey" "value: generative-contextualai"
  check_modules "--set modules.reranker-contextualai.enabled=true" "value: reranker-contextualai"
  check_modules "--set modules.reranker-contextualai.enabled=true --set modules.reranker-contextualai.apiKey=apiKey" "value: reranker-contextualai"
  ...
  check_string_existence "--set mcpService.enabled=true" "containerPort: 9000"
  ...
  check_setting_has_value "--set mcpService.enabled=true" "name: MCP_SERVER_WRITE_ACCESS_DISABLED" "value: \"true\""
  ...
  check_string_existence "--set mcpService.enabled=true --set mcpService.config.tools.test-tool.description=test-description" "name: weaviate-mcp-config"
  check_string_existence "--set mcpService.enabled=true --set mcpService.config.tools.test-tool.description=test-description" "mcp-config.yaml"
  check_string_existence "--set mcpService.enabled=true --set mcpService.config.tools.test-tool.description=test-description" "test-description"
  check_no_setting "--set mcpService.enabled=true" "name: MCP_SERVER_CONFIG_PATH"
  check_no_setting "--set mcpService.enabled=true" "weaviate-mcp-config"
  ...
  check_no_setting "--set mcpService.enabled=false" "name: MCP_SERVER_ENABLED"
  check_modules "--set mcpService.enabled=true --set modules.text2vec-contextionary.enabled=false --set modules.text2vec-transformers.enabled=true" "value: text2vec-transformers"
  ...
  check_string_existence "--set modules.reranker-contextualai.enabled=true --set modules.reranker-contextualai.apiKey=apiKey" "name: CONTEXTUALAI_APIKEY"
  check_string_existence "--set modules.generative-contextualai.enabled=true --set modules.generative-contextualai.apiKey=apiKey" "name: CONTEXTUALAI_APIKEY"
  check_string_existence "--set modules.generative-contextualai.enabled=true --set modules.generative-contextualai.apiKey=apiKey --set modules.reranker-contextualai.enabled=true --set modules.reranker-contextualai.apiKey=apiKey" "name: CONTEXTUALAI_APIKEY"
